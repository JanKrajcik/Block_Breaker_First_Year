...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("BrickBreaker", 402, 650,
                    Color.black);
        }
    ...
    /**
     * V tejto triede som pridal funkcionalitu, ktorá zavrie okno pri stlačení X vpravo hore v okne,
     * zakázal som menenie veľkosti okna, nakoľko sa s tým hra nevie vysporiadať.
     *
     * Create a Canvas.
    ...
    private Platno(String titulok, int sirka, int vyska, Color pozadie) {
        ...
        // Pridana funkcia, ktora po zruseni okna zrusi aj appku.
