 ...
 *
 * Upravil Ján Krajčík tak, aby sa dala meniť dĺžka ticku.
 *
 *  @author Ján Krajčík,
...
public class Manazer {
    ...
    private static long tickLength = 100000000/*50000000*/;
    ...
    private class ManazerCasovaca implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            if (newTick - Manazer.this.oldTick >= Manazer.tickLength || newTick < Manazer.tickLength) {
                Manazer.this.oldTick = (newTick / Manazer.tickLength) * Manazer.tickLength;
    ...
    /**
     * Používa sa miesto vyhadzovania errorov, tak sa to na FRI UNIZA robí :).
     */
    private void doNothing() {
        System.out.println("Nastala chyba, ale UNIZA ju pred tebou taji!");
    }

    /**
     * Nastaví dĺžku ticku na požadovanú, podľa obtiažnosti, čo mení gynamiku hry.
     * @param tickLength  Dĺžka ticku, na ktorú sa má nastaviť.
     */
